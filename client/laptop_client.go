...
// LaptopClient is a client to call laptop service LPCs
type LaptopClient struct {
	service pb.LaptopServiceClient
}

// NewLaptopClient retyurns a new laptop client
...
func (laptopClient *LaptopClient) CreateLaptop(laptop *pb.Laptop) {
	...
	log.Printf("Create laptop whit id: %s", res.Id)
}
