...
func TestClientCreateLaptop(t *testing.T) {
	...
	// chek that the laptop is saved to the store
...
func TestClientUploadImage(t *testing.T) {
	...
	serveAddress := startTestLaptopServer(t, laptopStore, imageStore, nil)
	latopClieant := newTestLaptopClient(t, serveAddress)
	...
	stream, err := latopClieant.UploadImage(context.Background())
	require.NoError(t, err)
...
func TestClientRateLaptop(t *testing.T) {
	...
	serveAddress := startTestLaptopServer(t, laptopStore, nil, ratingStore)
	latopClieant := newTestLaptopClient(t, serveAddress)

	stream, err := latopClieant.RateLaptop(context.Background())
	require.NoError(t, err)
